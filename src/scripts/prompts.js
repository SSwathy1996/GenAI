...
export const DEFAULT_PROMPTS = {
  ...
  /****
   * Test data generator for DOM
   */
  TEST_DATA_ONLY: `
    Instructions:
    - Generate ONLY a test data table for the selected DOM elements (no test code, no explanations).
    - For each input field, provide at least 2 positive and 2 negative test data values.
    - Use a wide variety of realistic, meaningful, and edge-case data (not limited to southern India).
    - Use clear, human-friendly field names as shown in the DOM.
    - Format the output as a markdown table for easy copy-paste and readability.
  ...
  | Field Name      | Positive Test Data                | Negative Test Data                |
  |-----------------|-----------------------------------|-----------------------------------|
  | Username        | alice123, John_Doe, user2025      | "", "<script>", "@badname"        |
  | Password        | Passw0rd!, Qwerty@2025            | "", "123", "password"             |
  | Email           | alice@mail.com, test@domain.org   | "", "not-an-email", "@.com"       |
  | Age             | 25, 40, 99                        | -1, 0, "abc"                      |

  - Please use markdown table syntax with a header row and separator row.
  - Do not include any code blocks or extra text, just the table.

    Persona:
    - Audience: Automation engineer focusing on realistic, enterprise-ready test data.

    Output Format:
    - Markdown table only, as shown above.

    Tone:
    - Clean, readable, enterprise-ready.
  `,
